...
7. On the following page you will need to complete with your information some parameters like the ones listed below. Navigate thoughout the different sections by clicking "**Next**".
